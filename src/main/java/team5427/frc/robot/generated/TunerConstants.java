...
public class TunerConstants {
  ...
  public static final CANBus kCANBus = new CANBus("nplus1", "./logs/example.hoot");

  // Theoretical free speed (m/s) at 12 V applied output;
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(10.19);
  ...
  private static final Distance kWheelRadius = Inches.of(3.98);
